...
<html lang="en">
    <head>
        ...
        <title>Ecommerce Cart Website Using PHP and MySQL.</title>
...
<!--    php code to display dynamic cart data-->
    ...
    if($result_count>0){  //condition to check if cart is empty or has item
        echo "<thead>
        <tr>
           <th>Product Title</th>
           <th>Product Image</th>
...
?>
                            ...
                            <tr>
                                ...
                                <td><img src="Admin%20Area/Product_images/<?php echo $product_image1?>" alt="" class="cart_img"></td>
...
<?php
      } //this section will be included in the above php code
    }
    }else{
