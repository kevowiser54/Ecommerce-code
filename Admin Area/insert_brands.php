...
if(isset($_POST['insert_brand'])){
    ...
    if($number>0){
        echo "<script>alert('This brand exist in the database')</script>";
    }else{
        $insert_query="INSERT INTO brands (brand_title) VALUES ('$brand_title')"; $result=mysqli_query($con,$insert_query);
        if($result){
